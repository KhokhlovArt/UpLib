...
Java_com_mks_uplib_C_getPassToCert_1ndk(JNIEnv *env, jobject instance) {
    char str_pass[6] = { 0 };
    str_pass[0] = '1';
    str_pass[1] = '2';
    str_pass[2] = '3';
...
JNIEXPORT jstring JNICALL
Java_com_mks_uplib_C_getCert_1ndk(JNIEnv *env, jobject instance) {
...
JNIEXPORT jstring JNICALL
Java_com_mks_uplib_C_stringFromJNI(JNIEnv *env, jobject instance) {
    char ARG[58] = { 0 };
    ARG[0] = '6';
    ARG[1] = '7';
    ARG[2] = '8';
...
JNIEXPORT jstring JNICALL
Java_com_mks_uplib_Service_CryptoProvider_CryptoProviderServicer_codeFromJNI(JNIEnv *env,
                                                                             jclass type,
                                                                             jstring str_) {
    ...
    jclass clazz_test    = (*env)->FindClass(env, "com/mks/uplib/Service/CryptoProvider/CryptoProviderServicer");
...
JNIEXPORT jstring JNICALL
Java_com_mks_uplib_Service_CryptoProvider_CryptoProviderServicer_decodeFromJNI(JNIEnv *env,
                                                                               jclass type,
                                                                               jstring str_) {
    const char *str = (*env)->GetStringUTFChars(env, str_, 0);
    //******************* скроываем в бинарнике String-овые строки *********************************
